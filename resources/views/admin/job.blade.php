        ...
        <form class="form-horizontal" id="EditForm">
          ...
          <div class="modal-body">
            <div class="form-group row">
              <label for="inputText" class="col-sm-2 col-form-label">ID_JOB</label>
              <div class="col-sm-10">
                <div class="input-group input-group-sm">
                  <input type="text" name="ID_JOB" id="eId"  class="form-control" placeholder="Uraian" required>
                </div>
              </div>
              ...
              <div class="col-sm-10">
                <div class="input-group input-group-sm">
                  <input type="text" name="Uraian" id="eUraian"  class="form-control" placeholder="Uraian" required>
                </div>
              </div>
            </div>
          </div>
...
@section('script_e')
  <script>
    ...
    $('.InfoBtn').on('click',function() {
      $.get("Det_Job/"+$(this).attr("value"))
        .done(function(data){
          $("#aCPL").text(data[0].ID);
          $("#aKet").text(data[0].paragraf);
        });
    });
      // Modal Add & Edit
