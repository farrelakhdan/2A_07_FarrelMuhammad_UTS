        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="show_wp" class="nav-link">
                  <i class="nav-icon far fa-circle text-danger"></i>
                  <p>Web Programming</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="show_mp" class="nav-link">
                  <i class="nav-icon far fa-circle text-danger"></i>
                  <p>Mobile Programming</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="show_wd" class="nav-link">
                  <i class="nav-icon far fa-circle text-danger"></i>
                  <p>Web Designer</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="show_product" class="nav-link">
          ...
          <li class="nav-item">
            <a href="show_contact" class="nav-link">
